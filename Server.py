...
def handleClient(conn):
    ...
    while connected:
        ...
        if msgLength:
            ...
            if msg.RequestType == RequestType.CREATE_GAME:
            ...
            elif msg.RequestType == RequestType.GET_GAME_VARS:
                sendMessage(200, conn, value=gameThread.gameVars)
            elif msg.RequestType == RequestType.SET_Y:
                if msg.value:
                    if Cardinality == 0:
                ...
                try:
                    ...
                    sendMessage(500, conn)
                    continue
            elif msg.RequestType == RequestType.DISCONNECT:
                connected = False
                playerCount -= 1
                if Cardinality == 0:
                ...
                print(f"[UNEXPECTED REQUEST] type:{msg.RequestType} value: {msg.value}")
